...
public abstract class AbstractTestContainer {
  ...
  public static final String TASKS_API_URI = "/api/v1/tasks";
  public static final String TASKS_API_ID_URI = "/api/v1/tasks/%d";

  public static final String TASKS_EXECUTOR_URI = "/api/v1/tasks";
  public static final String TASKS_EXECUTOR_ID_URI = "/api/v1/tasks/%d";
