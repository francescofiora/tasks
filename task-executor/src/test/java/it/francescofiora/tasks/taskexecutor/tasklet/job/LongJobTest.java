...
public class LongJobTest {
  ...
  void test() throws Exception {
    ...
    parameters.put(JmsParameters.JOB_TYPE, new JobParameter(JobType.LONG.name()));
  ...
  static class BatchConfiguration {
    ...
    @Bean
    public LongTasklet getLongTasklet(TaskService taskService) {
      return new LongTasklet(taskService);
    }

    @Bean
    public JobLauncherTestUtils jobLauncherTestUtils(Job longJob) throws NoSuchJobException {
      JobLauncherTestUtils jobLauncherTestUtils = new JobLauncherTestUtils();
      jobLauncherTestUtils.setJob(longJob);
